...
|- | 2024 | **MonST3R: A Simple Approach for Estimating Geometry in the Presence of Motion**  | ICLR 2025 |          [Link](https://arxiv.org/abs/2410.03825)          | [Link](https://github.com/Junyi42/monst3r)     |  [Link](https://monst3r-project.github.io/) |
...
#### 7. 4K4DGen: Panoramic 4D Generation at 4K Resolution
...
#### 8. Shape of Motion: 4D Reconstruction from a Single Video
...
#### 9. 4Dynamic: Text-to-4D Generation with Hybrid Priors
...
#### 10. CT4D: Consistent Text-to-4D Generation with Animatable Meshes
...
#### 11. Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### 12. AvatarGO: Zero-shot 4D Human-Object Interaction Generation and Animation
...
#### 13. Trans4D: Realistic Geometry-Aware Transition for Compositional Text-to-4D Synthesis
...
#### 14. 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### 15. GenXD: Generating Any 3D and 4D Scenes
...
#### 16. DimensionX: Create Any 3D and 4D Scenes from a Single Image with Controllable Video Diffusion
...
#### 17. CAT4D: Create Anything in 4D with Multi-View Video Diffusion Models
...
#### 18. PaintScene4D: Consistent 4D Scene Generation from Text Prompts
...
#### 19. 4Real-Video: Learning Generalizable Photo-Realistic 4D Video Diffusion
...
#### 20. ZeroHSI: Zero-Shot 4D Human-Scene Interaction by Video Generation
...
#### 21. Bringing Objects to Life: 4D generation from 3D objects
