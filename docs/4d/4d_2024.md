...
#### 12. MonST3R: A Simple Approach for Estimating Geometry in the Presence of Motion
...
#### 13. AvatarGO: Zero-shot 4D Human-Object Interaction Generation and Animation
...
#### 14. Trans4D: Realistic Geometry-Aware Transition for Compositional Text-to-4D Synthesis
...
#### 16. GenXD: Generating Any 3D and 4D Scenes
...
#### 17. DimensionX: Create Any 3D and 4D Scenes from a Single Image with Controllable Video Diffusion
...
#### 19. PaintScene4D: Consistent 4D Scene Generation from Text Prompts
...
#### 20. 4Real-Video: Learning Generalizable Photo-Realistic 4D Video Diffusion
...
#### 21. ZeroHSI: Zero-Shot 4D Human-Scene Interaction by Video Generation
...
#### 22. Bringing Objects to Life: 4D generation from 3D objects
