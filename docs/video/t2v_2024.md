...
#### 5. Tora: Trajectory-oriented Diffusion Transformer for Video Generation
...
#### 6. BroadWay: Boost Your Text-to-Video Generation Model in a Training-free Way
...
#### 8. GameGen-X: Interactive Open-world Game Video Generation
...
#### 9. Motion Control for Enhanced Complex Action Video Generation
...
#### 10. AnimateAnything: Consistent and Controllable Animation for video generation
...
#### 11. FlipSketch: Flipping Static Drawings to Text-Guided Sketch Animations (Text-to-Video Finetuning)
...
#### 12. DreamRunner: Fine-Grained Storytelling Video Generation with Retrieval-Augmented Motion Adaptation
...
#### 13. PhyT2V: LLM-Guided Iterative Self-Refinement for Physics-Grounded Text-to-Video Generation
...
#### 15. Mogo: RQ Hierarchical Causal Transformer for High-Quality 3D Human Motion Generation
Dongjie Fu (Mogo AI)
<details span>
<summary><b>Abstract</b></summary>
...
#### 16. Mind the Time: Temporally-Controlled Multi-Event Video Generation
